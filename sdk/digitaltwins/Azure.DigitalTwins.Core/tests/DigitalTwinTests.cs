...
namespace Azure.DigitalTwins.Core.Tests
{
    ...
    public class DigitalTwinTests : E2eTestBase
    {
        ...
        public async Task DigitalTwinOperationsWithCustomObjectSerializer_Succeeds()
        {
            ...
            serializer.isDeserializeCalled.Should().Be(false);
            serializer.isSerializeCalled.Should().Be(false);
            ...
            serializer.isDeserializeCalled.Should().Be(true);
            serializer.isSerializeCalled.Should().Be(true);
        }
    }
}
